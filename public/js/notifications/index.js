window.addEventListener("load", () => {
    addEventToButtonNotifications();
});

/**
 *
 */
const addEventToButtonNotifications = () => {
    let button = document.getElementById("button-notifications");
    button.addEventListener("click", handlerButtonNotifications);
};

/**
 *
 */
const handlerButtonNotifications = () => {
    axios
