<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4 py-3" >
            ...
            <div x-data="{show : true}" class="relative text-gray-600 focus-within:text-gray-400">
                ...
                <span class="absolute inset-y-0 right-0 flex items-center pr-2">
                    <button type="button" @click="show = !show" class="p-1 focus:outline-none focus:shadow-outline">
        ...
        <!-- Log in button -->
        <div class="flex items-center justify-end mt-4 py-3">
        ...
        <div class="flex items-center justify-center flex-col py-2">
            <div>
                <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('register') }}">
                    {{ __("Don't have a account? Sign up now") }}
                </a>
            </div>
        </div>
    </form>
